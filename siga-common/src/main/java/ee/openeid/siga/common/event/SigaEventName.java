...
public enum SigaEventName {
    ...
    public enum EventParam {
        CONTAINER_ID, REQUEST_URL, SIGNATURE_ID, ISSUING_CA, DDS_RESPONSE_CODE, MID_REST_RESULT, SESSION_CODE, DDS_SESSION_ID, SIGN_CERT_STATUS, PERSON_IDENTIFIER, COUNTRY, PHONE_NR, RELYING_PARTY_NAME, SIGNATURE_PROFILE, NO_OF_DATAFILES
    }
}
