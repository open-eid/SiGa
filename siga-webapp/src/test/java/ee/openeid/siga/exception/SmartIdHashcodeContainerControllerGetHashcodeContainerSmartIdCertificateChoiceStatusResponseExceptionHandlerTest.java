...
class SmartIdHashcodeContainerControllerGetHashcodeContainerSmartIdCertificateChoiceStatusResponseExceptionHandlerTest extends ExceptionHandlerTestBase {
    ...
    protected ResultActions performRequestAndReturnResponse(Throwable toThrowInController) throws Exception {
        ...
        String url = "/hashcodecontainers/" + containerId + "/smartidsigning/certificatechoice/" + certificateId + "/status";
