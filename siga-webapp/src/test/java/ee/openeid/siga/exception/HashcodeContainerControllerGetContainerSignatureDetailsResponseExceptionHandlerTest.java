...
class HashcodeContainerControllerGetContainerSignatureDetailsResponseExceptionHandlerTest extends ExceptionHandlerTestBase {
    ...
    protected ResultActions performRequestAndReturnResponse(Throwable toThrowInController) throws Exception {
        ...
        String url = "/hashcodecontainers/" + containerId + "/signatures/" + signatureId;
