...
class HashcodeContainerControllerDeleteHashcodeContainerDataFileResponseExceptionHandlerTest extends ExceptionHandlerTestBase {
    ...
    protected ResultActions performRequestAndReturnResponse(Throwable toThrowInController) throws Exception {
        ...
        String datafileName = "datafile.asice";
        String url = "/hashcodecontainers/" + containerId + "/datafiles/" + datafileName;
