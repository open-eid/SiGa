...
class HashcodeContainerControllerGetHashcodeContainerValidationReportResponseExceptionHandlerTest extends ExceptionHandlerTestBase {
    ...
    protected ResultActions performRequestAndReturnResponse(Throwable toThrowInController) throws Exception {
        ...
        String containerId = "dummyId";
        return performGet("/hashcodecontainers/{containerId}/validationreport", containerId);
    }
}
