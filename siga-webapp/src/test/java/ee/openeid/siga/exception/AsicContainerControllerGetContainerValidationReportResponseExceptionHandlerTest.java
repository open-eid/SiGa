...
class AsicContainerControllerGetContainerValidationReportResponseExceptionHandlerTest extends ExceptionHandlerTestBase {
    ...
    protected ResultActions performRequestAndReturnResponse(Throwable toThrowInController) throws Exception {
        ...
        }).when(validationService).validateExistingContainer(anyString());

        String dummyContainerId = "dummy-container-id";
        return performGet("/containers/{containerId}/validationreport", dummyContainerId);
    }
}
