...
class HashcodeContainerControllerUploadHashcodeContainerResponseExceptionHandlerTest extends ExceptionHandlerTestBase {
    ...
    protected ResultActions performRequestAndReturnResponse(Throwable toThrowInController) throws Exception {
        ...
        String dummySignatureValue = "dGVzdC1zaWduYXR1cmUtdmFsdWU=";
        JSONObject request = createFinalizeRemoteSigningRequest(dummySignatureValue);
        String url = "/hashcodecontainers/" + containerId + "/remotesigning/" + signatureId;
        return performPut(url, request);
    }
}
