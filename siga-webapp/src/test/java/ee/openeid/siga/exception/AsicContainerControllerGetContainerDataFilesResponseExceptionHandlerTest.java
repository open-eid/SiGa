...
class AsicContainerControllerGetContainerDataFilesResponseExceptionHandlerTest extends ExceptionHandlerTestBase {
    ...
    protected ResultActions performRequestAndReturnResponse(Throwable toThrowInController) throws Exception {
        ...
        String url = "/containers/" + containerId + "/datafiles";
