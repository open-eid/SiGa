...
class HashcodeContainerControllerCreateHashcodeContainerValidationReportResponseExceptionHandlerTest extends ExceptionHandlerTestBase {
    ...
    protected ResultActions performRequestAndReturnResponse(Throwable toThrowInController) throws Exception {
        ...
        }).when(validator).validateFileContent(anyString());

        JSONObject request = createUploadContainerRequest("VGVzdC4=", "datafile.asice");
        return performPost("/hashcodecontainers/validationreport", request);
    }
}
