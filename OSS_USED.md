...
Lists of 48 third-party dependencies.
     (Eclipse Public License - v 1.0) (GNU Lesser General Public License) Logback Classic Module (ch.qos.logback:logback-classic:1.5.26 - http://logback.qos.ch/logback-classic)
     (Eclipse Public License - v 1.0) (GNU Lesser General Public License) Logback Core Module (ch.qos.logback:logback-core:1.5.26 - http://logback.qos.ch/logback-core)
     ...
     (Apache License, Version 2.0) siga-auth (ee.openeid.siga:siga-auth:2.12.0 - https://spring.io/projects/spring-boot/siga-parent/siga-auth)
     (Apache License, Version 2.0) siga-common (ee.openeid.siga:siga-common:2.12.0 - https://spring.io/projects/spring-boot/siga-parent/siga-common)
     (Apache License, Version 2.0) siga-monitoring (ee.openeid.siga:siga-monitoring:2.12.0 - https://spring.io/projects/spring-boot/siga-parent/siga-monitoring)
     (Apache License, Version 2.0) siga-session-storage (ee.openeid.siga:siga-session-storage:2.12.0 - https://spring.io/projects/spring-boot/siga-parent/siga-session-storage)
     (Apache License, Version 2.0) siga-signature-service (ee.openeid.siga:siga-signature-service:2.12.0 - https://spring.io/projects/spring-boot/siga-parent/siga-signature-service)
     ...
     (Apache License, Version 2.0) Reactor Test support (io.projectreactor:reactor-test:3.7.15 - https://github.com/reactor/reactor-core)
     ...
     (Eclipse Distribution License - v 1.0) JAXB Runtime (org.glassfish.jaxb:jaxb-runtime:4.0.6 - https://eclipse-ee4j.github.io/jaxb-ri/)
     ...
     (BSD-2-Clause) PostgreSQL JDBC Driver (org.postgresql:postgresql:42.7.9 - https://jdbc.postgresql.org)
     ...
     (Apache License, Version 2.0) spring-boot-starter-data-jpa (org.springframework.boot:spring-boot-starter-data-jpa:3.5.10 - https://spring.io/projects/spring-boot)
     ...
     (Apache License, Version 2.0) spring-boot-starter-test (org.springframework.boot:spring-boot-starter-test:3.5.10 - https://spring.io/projects/spring-boot)
     ...
     (Apache License, Version 2.0) spring-boot-starter-webflux (org.springframework.boot:spring-boot-starter-webflux:3.5.10 - https://spring.io/projects/spring-boot)
     (Apache License, Version 2.0) spring-security-test (org.springframework.security:spring-security-test:6.5.7 - https://spring.io/projects/spring-security)
